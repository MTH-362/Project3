...
Below are two graphs- one exploring the relation between category 2 defects and the total cup points, and the other confirming there is no multicolinearity between the two categories of defects. 
