...
model3 <- lm(Total.Cup.Points~ Category.Two.Defects + Moisture, data = coffee_ratings2)
...
coffee.new <- coffee.new %>% mutate(predict.inverse = gamma.inverse$fitted.values, 
                                    predict.identity = gamma.identity$fitted.values,
                                    predict.log = gamma.log$fitted.values,
