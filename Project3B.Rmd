...
gamma.log <- glm(Total.Cup.Points ~ . - Flavor - Cupper.Points - 
    ...
    Sweetness - Uniformity - predict.identity - predict.log - 
    predict.inverse - predict.linear, family = Gamma(link = "log"),  data = coffee.new)
summary(gamma.log)
...
```{r}
gamma.identity <- glm(Total.Cup.Points ~ . - Flavor - Cupper.Points - Aroma - Aftertaste - Body - Acidity - Balance - Clean.Cup - Sweetness - Uniformity - predict.identity - predict.log - predict.inverse - predict.linear, family = Gamma(link = "identity"),  data = coffee.new)
