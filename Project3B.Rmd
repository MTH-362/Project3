...
coffee.new <- coffee.clean %>% mutate(
  processing_method = case_when(
    processing_method == "Pulped natural / honey" ~ 1,
    processing_method == "Natural / Dry" ~ 2,
    processing_method == "Washed / Wet" ~ 3,
    processing_method == "Other" ~ 4),
  color = case_when(
    color == "Green" ~ 0,
    color == "Blue-Green" ~ 1,
  ...
  country_group = case_when(
    country_of_origin %in% c("El Salvador", "Costa Rica", "Guatemala", "Honduras", "Brazil", "Mexico", "Nicaragua") ~ 1,
    country_of_origin %in% c("Uganda", "Tanzania, United Republic Of") ~ 2,
    country_of_origin %in% c("Taiwan", "Indonesia", "China") ~ 3
...
ggplot(data= coffee.new, aes(x = flavor, y = total_cup_points, fill = factor(country_group))) +
